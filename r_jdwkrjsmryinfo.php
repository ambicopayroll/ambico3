...
//
// Table class for r_jdwkrj
//
class crr_jdwkrj extends crTableBase {
	...
	function __construct() {
		...
		$this->TableVar = 'r_jdwkrj';
		$this->TableName = 'r_jdwkrj';
		...
		// pegawai_nama
		$this->pegawai_nama = new crField('r_jdwkrj', 'r_jdwkrj', 'x_pegawai_nama', 'pegawai_nama', '`pegawai_nama`', 200, EWR_DATATYPE_STRING, -1);
		...
		// tgl_indo
		$this->tgl_indo = new crField('r_jdwkrj', 'r_jdwkrj', 'x_tgl_indo', 'tgl_indo', '`tgl_indo`', 200, EWR_DATATYPE_STRING, -1);
		$this->tgl_indo->Sortable = TRUE; // Allow sort
		$this->fields['tgl_indo'] = &$this->tgl_indo;
		$this->tgl_indo->DateFilter = "";
		$this->tgl_indo->SqlSelect = "";
		$this->tgl_indo->SqlOrderBy = "";

		// jk_kd
		$this->jk_kd = new crField('r_jdwkrj', 'r_jdwkrj', 'x_jk_kd', 'jk_kd', '`jk_kd`', 200, EWR_DATATYPE_STRING, -1);
		...
		// hk_def
		$this->hk_def = new crField('r_jdwkrj', 'r_jdwkrj', 'x_hk_def', 'hk_def', '`hk_def`', 16, EWR_DATATYPE_NUMBER, -1);
		...
		// tgl
		$this->tgl = new crField('r_jdwkrj', 'r_jdwkrj', 'x_tgl', 'tgl', '`tgl`', 133, EWR_DATATYPE_DATE, 0);
