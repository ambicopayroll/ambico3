...
$lap_gaji2__php = NULL; // Initialize page object first

class clap_gaji2__php {
	...
	// Table name
	var $TableName = 'lap_gaji2_.php';

	// Page object name
	var $PageObjName = 'lap_gaji2__php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'lap_gaji2_.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "lap_gaji2__php", $url, "", "lap_gaji2__php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($lap_gaji2__php)) $lap_gaji2__php = new clap_gaji2__php();

// Page init
$lap_gaji2__php->Page_Init();

// Page main
$lap_gaji2__php->Page_Main();
