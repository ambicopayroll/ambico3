...
$t_jdw_krj_def_view = NULL; // Initialize page object first

class ct_jdw_krj_def_view extends ct_jdw_krj_def {
	...
	// Page object name
	var $PageObjName = 't_jdw_krj_def_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t_jdw_krj_deflist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "t_jdw_krj_deflist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t_jdw_krj_def_view)) $t_jdw_krj_def_view = new ct_jdw_krj_def_view();

// Page init
$t_jdw_krj_def_view->Page_Init();

// Page main
$t_jdw_krj_def_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_jdw_krj_def_view->Page_Render();
?>
...
var CurrentForm = ft_jdw_krj_defview = new ew_Form("ft_jdw_krj_defview", "view");

// Form_CustomValidate event
ft_jdw_krj_defview.Form_CustomValidate = 
...
ft_jdw_krj_defview.ValidateRequired = true;
<?php } else { ?>
ft_jdw_krj_defview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($t_jdw_krj_def->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t_jdw_krj_def_view->IsModal) { ?>
<?php if ($t_jdw_krj_def->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $t_jdw_krj_def_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t_jdw_krj_def_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t_jdw_krj_def_view->IsModal) { ?>
<?php if ($t_jdw_krj_def->Export == "") { ?>
...
<?php } ?>
<?php $t_jdw_krj_def_view->ShowPageHeader(); ?>
<?php
$t_jdw_krj_def_view->ShowMessage();
?>
<?php if (!$t_jdw_krj_def_view->IsModal) { ?>
<?php if ($t_jdw_krj_def->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t_jdw_krj_def_view->Pager)) $t_jdw_krj_def_view->Pager = new cPrevNextPager($t_jdw_krj_def_view->StartRec, $t_jdw_krj_def_view->DisplayRecs, $t_jdw_krj_def_view->TotalRecs) ?>
<?php if ($t_jdw_krj_def_view->Pager->RecordCount > 0 && $t_jdw_krj_def_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t_jdw_krj_def_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t_jdw_krj_def_view->PageUrl() ?>start=<?php echo $t_jdw_krj_def_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t_jdw_krj_def_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t_jdw_krj_def_view->PageUrl() ?>start=<?php echo $t_jdw_krj_def_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t_jdw_krj_def_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t_jdw_krj_def_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t_jdw_krj_def_view->PageUrl() ?>start=<?php echo $t_jdw_krj_def_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t_jdw_krj_def_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t_jdw_krj_def_view->PageUrl() ?>start=<?php echo $t_jdw_krj_def_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t_jdw_krj_def_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="ft_jdw_krj_defview" id="ft_jdw_krj_defview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_jdw_krj_def_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_jdw_krj_def_view->Token ?>">
<?php } ?>
...
<?php echo $t_jdw_krj_def->pegawai_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jdw_krj_def->tgl->Visible) { // tgl ?>
	<tr id="r_tgl">
		<td><span id="elh_t_jdw_krj_def_tgl"><?php echo $t_jdw_krj_def->tgl->FldCaption() ?></span></td>
...
<?php echo $t_jdw_krj_def->tgl->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jdw_krj_def->jk_id->Visible) { // jk_id ?>
	<tr id="r_jk_id">
		<td><span id="elh_t_jdw_krj_def_jk_id"><?php echo $t_jdw_krj_def->jk_id->FldCaption() ?></span></td>
...
<?php if ($t_jdw_krj_def->Export == "") { ?>
<script type="text/javascript">
ft_jdw_krj_defview.Init();
</script>
<?php } ?>
<?php
$t_jdw_krj_def_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($t_jdw_krj_def->Export == "") { ?>
...
<?php
$t_jdw_krj_def_view->Page_Terminate();
?>
