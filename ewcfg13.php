...
define("EW_PROJECT_NAME", "ambico3", TRUE); // Project name
...
define("EW_RANDOM_KEY", '5tptQNVFs2kiRYlT', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "fin_pro", "qs" => "`", "qe" => "`");
