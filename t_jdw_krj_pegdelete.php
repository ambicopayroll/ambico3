...
$t_jdw_krj_peg_delete = NULL; // Initialize page object first

class ct_jdw_krj_peg_delete extends ct_jdw_krj_peg {
	...
	// Page object name
	var $PageObjName = 't_jdw_krj_peg_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t_jdw_krj_peglist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t_jdw_krj_peg class, t_jdw_krj_peginfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t_jdw_krj_peglist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t_jdw_krj_peg_delete)) $t_jdw_krj_peg_delete = new ct_jdw_krj_peg_delete();

// Page init
$t_jdw_krj_peg_delete->Page_Init();

// Page main
$t_jdw_krj_peg_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_jdw_krj_peg_delete->Page_Render();
?>
...
var CurrentForm = ft_jdw_krj_pegdelete = new ew_Form("ft_jdw_krj_pegdelete", "delete");

// Form_CustomValidate event
ft_jdw_krj_pegdelete.Form_CustomValidate = 
...
ft_jdw_krj_pegdelete.ValidateRequired = true;
<?php } else { ?>
ft_jdw_krj_pegdelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_jdw_krj_pegdelete.Lists["x_pegawai_id"] = {"LinkField":"x_pegawai_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_pegawai_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"pegawai"};
ft_jdw_krj_pegdelete.Lists["x_jk_id"] = {"LinkField":"x_jk_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_jk_nm","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_jk"};
ft_jdw_krj_pegdelete.Lists["x_hk"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_jdw_krj_pegdelete.Lists["x_hk"].Options = <?php echo json_encode($t_jdw_krj_peg->hk->Options()) ?>;
...
<?php $t_jdw_krj_peg_delete->ShowPageHeader(); ?>
<?php
$t_jdw_krj_peg_delete->ShowMessage();
?>
<form name="ft_jdw_krj_pegdelete" id="ft_jdw_krj_pegdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_jdw_krj_peg_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_jdw_krj_peg_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t_jdw_krj_peg">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($t_jdw_krj_peg_delete->RecKeys as $key) { ?>
...
<?php if ($t_jdw_krj_peg->tgl1->Visible) { // tgl1 ?>
		<th><span id="elh_t_jdw_krj_peg_tgl1" class="t_jdw_krj_peg_tgl1"><?php echo $t_jdw_krj_peg->tgl1->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t_jdw_krj_peg->tgl2->Visible) { // tgl2 ?>
		<th><span id="elh_t_jdw_krj_peg_tgl2" class="t_jdw_krj_peg_tgl2"><?php echo $t_jdw_krj_peg->tgl2->FldCaption() ?></span></th>
<?php } ?>
...
<?php } ?>
	...
	<tbody>
<?php
$t_jdw_krj_peg_delete->RecCnt = 0;
$i = 0;
while (!$t_jdw_krj_peg_delete->Recordset->EOF) {
	$t_jdw_krj_peg_delete->RecCnt++;
	$t_jdw_krj_peg_delete->RowCnt++;

	// Set row properties
	$t_jdw_krj_peg->ResetAttrs();
	$t_jdw_krj_peg->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$t_jdw_krj_peg_delete->LoadRowValues($t_jdw_krj_peg_delete->Recordset);
...
<?php } ?>
<?php if ($t_jdw_krj_peg->tgl1->Visible) { // tgl1 ?>
		<td<?php echo $t_jdw_krj_peg->tgl1->CellAttributes() ?>>
<span id="el<?php echo $t_jdw_krj_peg_delete->RowCnt ?>_t_jdw_krj_peg_tgl1" class="t_jdw_krj_peg_tgl1">
...
<?php } ?>
<?php if ($t_jdw_krj_peg->tgl2->Visible) { // tgl2 ?>
		<td<?php echo $t_jdw_krj_peg->tgl2->CellAttributes() ?>>
<span id="el<?php echo $t_jdw_krj_peg_delete->RowCnt ?>_t_jdw_krj_peg_tgl2" class="t_jdw_krj_peg_tgl2">
...
<?php } ?>
<?php if ($t_jdw_krj_peg->jk_id->Visible) { // jk_id ?>
		<td<?php echo $t_jdw_krj_peg->jk_id->CellAttributes() ?>>
...
<?php
	$t_jdw_krj_peg_delete->Recordset->MoveNext();
}
$t_jdw_krj_peg_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_jdw_krj_peg_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft_jdw_krj_pegdelete.Init();
</script>
<?php
$t_jdw_krj_peg_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_jdw_krj_peg_delete->Page_Terminate();
?>
