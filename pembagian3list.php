	...
	function AddRow($rsold = NULL) {
		...
		if ($bInsertRow) {
			...
			if ($AddRow) {
				...
				$this->pembagian3_id->setDbValue($conn->Insert_ID());
				$rsnew['pembagian3_id'] = $this->pembagian3_id->DbValue;
			}
		} else {
			if ($this->getSuccessMessage() <> "" || $this->getFailureMessage() <> "") {
...
<?php } ?>
<?php if ($pembagian3_list->TotalRecs > 0) { ?>
<div class="ewPager">
<input type="hidden" name="t" value="pembagian3">
...
<?php if ($pembagian3_list->TotalRecs > 0 || $pembagian3->CurrentAction == "add" || $pembagian3->CurrentAction == "copy") { ?>
