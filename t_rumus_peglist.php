...
<?php if (!isset($t_rumus_peg_list->Pager)) $t_rumus_peg_list->Pager = new cNumericPager($t_rumus_peg_list->StartRec, $t_rumus_peg_list->DisplayRecs, $t_rumus_peg_list->TotalRecs, $t_rumus_peg_list->RecRange) ?>
...
<div class="ewNumericPage"><ul class="pagination">
	...
	<li><a href="<?php echo $t_rumus_peg_list->PageUrl() ?>start=<?php echo $t_rumus_peg_list->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($t_rumus_peg_list->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $t_rumus_peg_list->PageUrl() ?>start=<?php echo $t_rumus_peg_list->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($t_rumus_peg_list->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $t_rumus_peg_list->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($t_rumus_peg_list->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $t_rumus_peg_list->PageUrl() ?>start=<?php echo $t_rumus_peg_list->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($t_rumus_peg_list->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $t_rumus_peg_list->PageUrl() ?>start=<?php echo $t_rumus_peg_list->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</div>
...
<?php if ($t_rumus_peg_list->TotalRecs > 0 || $t_rumus_peg->CurrentAction == "gridedit") { ?>
...
<?php
	...
	if ($t_rumus_peg->CurrentAction <> "gridadd")
		$t_rumus_peg_list->Recordset->MoveNext();
}
?>
</tbody>
</table>
