...
<script type="text/javascript">
ew_CreateCalendar("ft_jdw_krj_peggrid", "x<?php echo $t_jdw_krj_peg_grid->RowIndex ?>_tgl1", 5);
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
ew_CreateCalendar("ft_jdw_krj_peggrid", "x<?php echo $t_jdw_krj_peg_grid->RowIndex ?>_tgl2", 5);
</script>
<?php } ?>
</span>
