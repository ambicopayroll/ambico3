...
$t_rumus2_peg_delete = NULL; // Initialize page object first

class ct_rumus2_peg_delete extends ct_rumus2_peg {
	...
	// Page object name
	var $PageObjName = 't_rumus2_peg_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t_rumus2_peglist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t_rumus2_peg class, t_rumus2_peginfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t_rumus2_peglist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t_rumus2_peg_delete)) $t_rumus2_peg_delete = new ct_rumus2_peg_delete();

// Page init
$t_rumus2_peg_delete->Page_Init();

// Page main
$t_rumus2_peg_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_rumus2_peg_delete->Page_Render();
?>
...
var CurrentForm = ft_rumus2_pegdelete = new ew_Form("ft_rumus2_pegdelete", "delete");

// Form_CustomValidate event
ft_rumus2_pegdelete.Form_CustomValidate = 
...
ft_rumus2_pegdelete.ValidateRequired = true;
<?php } else { ?>
ft_rumus2_pegdelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_rumus2_pegdelete.Lists["x_pegawai_id"] = {"LinkField":"x_pegawai_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_pegawai_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"pegawai"};
ft_rumus2_pegdelete.Lists["x_rumus2_id"] = {"LinkField":"x_rumus2_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_rumus2_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_rumus2"};
...
<?php $t_rumus2_peg_delete->ShowPageHeader(); ?>
<?php
$t_rumus2_peg_delete->ShowMessage();
?>
<form name="ft_rumus2_pegdelete" id="ft_rumus2_pegdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_rumus2_peg_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_rumus2_peg_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t_rumus2_peg">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($t_rumus2_peg_delete->RecKeys as $key) { ?>
...
<?php if ($t_rumus2_peg->pegawai_id->Visible) { // pegawai_id ?>
		<th><span id="elh_t_rumus2_peg_pegawai_id" class="t_rumus2_peg_pegawai_id"><?php echo $t_rumus2_peg->pegawai_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t_rumus2_peg->gp->Visible) { // gp ?>
		<th><span id="elh_t_rumus2_peg_gp" class="t_rumus2_peg_gp"><?php echo $t_rumus2_peg->gp->FldCaption() ?></span></th>
<?php } ?>
...
<?php } ?>
	...
	<tbody>
<?php
$t_rumus2_peg_delete->RecCnt = 0;
$i = 0;
while (!$t_rumus2_peg_delete->Recordset->EOF) {
	$t_rumus2_peg_delete->RecCnt++;
	$t_rumus2_peg_delete->RowCnt++;

	// Set row properties
	$t_rumus2_peg->ResetAttrs();
	$t_rumus2_peg->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$t_rumus2_peg_delete->LoadRowValues($t_rumus2_peg_delete->Recordset);

	// Render row
	$t_rumus2_peg_delete->RenderRow();
?>
	<tr<?php echo $t_rumus2_peg->RowAttributes() ?>>
<?php if ($t_rumus2_peg->pegawai_id->Visible) { // pegawai_id ?>
		<td<?php echo $t_rumus2_peg->pegawai_id->CellAttributes() ?>>
<span id="el<?php echo $t_rumus2_peg_delete->RowCnt ?>_t_rumus2_peg_pegawai_id" class="t_rumus2_peg_pegawai_id">
...
<?php } ?>
<?php if ($t_rumus2_peg->gp->Visible) { // gp ?>
		<td<?php echo $t_rumus2_peg->gp->CellAttributes() ?>>
<span id="el<?php echo $t_rumus2_peg_delete->RowCnt ?>_t_rumus2_peg_gp" class="t_rumus2_peg_gp">
...
<?php } ?>
<?php if ($t_rumus2_peg->rumus2_id->Visible) { // rumus2_id ?>
		<td<?php echo $t_rumus2_peg->rumus2_id->CellAttributes() ?>>
...
<?php
	$t_rumus2_peg_delete->Recordset->MoveNext();
}
$t_rumus2_peg_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_rumus2_peg_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft_rumus2_pegdelete.Init();
</script>
<?php
$t_rumus2_peg_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_rumus2_peg_delete->Page_Terminate();
?>
