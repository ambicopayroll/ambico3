...
$RootMenu->AddMenuItem(42, "mmi_t_jdw_krj_peg", $Language->MenuPhrase("42", "MenuText"), "t_jdw_krj_peglist.php", 30, "", AllowListMenu('{503C8825-3846-4E96-8DFF-03202C380E17}t_jdw_krj_peg'), FALSE, FALSE);
$RootMenu->AddMenuItem(45, "mmi_t_rumus_peg", $Language->MenuPhrase("45", "MenuText"), "t_rumus_peglist.php", 30, "", AllowListMenu('{503C8825-3846-4E96-8DFF-03202C380E17}t_rumus_peg'), FALSE, FALSE);
