	...
	function AddRow($rsold = NULL) {
		...
		if ($bInsertRow) {
			...
			if ($AddRow) {
				...
				$rsnew['pembagian2_id'] = $this->pembagian2_id->DbValue;
			}
		} else {
			if ($this->getSuccessMessage() <> "" || $this->getFailureMessage() <> "") {
...
<?php } ?>
<?php if ($pembagian2_list->TotalRecs > 0) { ?>
<div class="ewPager">
<input type="hidden" name="t" value="pembagian2">
...
<?php if ($pembagian2_list->TotalRecs > 0 || $pembagian2->CurrentAction == "add" || $pembagian2->CurrentAction == "copy") { ?>
