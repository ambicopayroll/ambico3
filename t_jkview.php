...
$t_jk_view = NULL; // Initialize page object first

class ct_jk_view extends ct_jk {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t_jklist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "t_jklist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_t_jk\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_t_jk',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.ft_jkview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($t_jk_view)) $t_jk_view = new ct_jk_view();
...
var CurrentForm = ft_jkview = new ew_Form("ft_jkview", "view");

// Form_CustomValidate event
ft_jkview.Form_CustomValidate = 
...
ft_jkview.ValidateRequired = true;
<?php } else { ?>
ft_jkview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($t_jk->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t_jk_view->IsModal) { ?>
<?php if ($t_jk->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $t_jk_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t_jk_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t_jk_view->IsModal) { ?>
<?php if ($t_jk->Export == "") { ?>
...
<?php } ?>
<?php $t_jk_view->ShowPageHeader(); ?>
<?php
$t_jk_view->ShowMessage();
?>
<?php if (!$t_jk_view->IsModal) { ?>
<?php if ($t_jk->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t_jk_view->Pager)) $t_jk_view->Pager = new cPrevNextPager($t_jk_view->StartRec, $t_jk_view->DisplayRecs, $t_jk_view->TotalRecs) ?>
<?php if ($t_jk_view->Pager->RecordCount > 0 && $t_jk_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t_jk_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t_jk_view->PageUrl() ?>start=<?php echo $t_jk_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t_jk_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t_jk_view->PageUrl() ?>start=<?php echo $t_jk_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t_jk_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t_jk_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t_jk_view->PageUrl() ?>start=<?php echo $t_jk_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t_jk_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t_jk_view->PageUrl() ?>start=<?php echo $t_jk_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t_jk_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="ft_jkview" id="ft_jkview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_jk_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_jk_view->Token ?>">
<?php } ?>
...
<?php echo $t_jk->jk_nm->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
