...
<?php if (!isset($t_jk_view->Pager)) $t_jk_view->Pager = new cNumericPager($t_jk_view->StartRec, $t_jk_view->DisplayRecs, $t_jk_view->TotalRecs, $t_jk_view->RecRange) ?>
<?php if ($t_jk_view->Pager->RecordCount > 0 && $t_jk_view->Pager->Visible) { ?>
<div class="ewPager">
<div class="ewNumericPage"><ul class="pagination">
	<?php if ($t_jk_view->Pager->FirstButton->Enabled) { ?>
	<li><a href="<?php echo $t_jk_view->PageUrl() ?>start=<?php echo $t_jk_view->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($t_jk_view->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $t_jk_view->PageUrl() ?>start=<?php echo $t_jk_view->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($t_jk_view->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $t_jk_view->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($t_jk_view->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $t_jk_view->PageUrl() ?>start=<?php echo $t_jk_view->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($t_jk_view->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $t_jk_view->PageUrl() ?>start=<?php echo $t_jk_view->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</div>
<?php } ?>
