...
define("EWR_PROJECT_ID", "{049CCBC0-CFE5-40D9-8A80-2D734899363E}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "ambico3", TRUE); // Project Name
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "fin_pro", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'P7cJrxzX6HNgwtt8', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/ambico3.css", TRUE); // Project stylesheet file name
 ...
 */
define("EWR_ENCRYPTED_PASSWORD", TRUE, TRUE); // Use encrypted password
...
define("EWR_TABLE_PREFIX", "{049CCBC0-CFE5-40D9-8A80-2D734899363E}", TRUE);
