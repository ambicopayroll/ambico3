...
function ewr_AutoLoad($class) {
	...
	if ($class == "GD") {
		...
		$file = str_replace("%cls%", substr($class, 2) . "rpt", "%cls%info.php");
	}
...
function CurrentProjectID() {
	...
	return "{049CCBC0-CFE5-40D9-8A80-2D734899363E}";
}
...
function Database_Connecting(&$info) {
	...
	} elseif (ewr_CurrentHost () == "ambico3.nma-indonesia.com") { // setting koneksi database untuk komputer server
	...
	} elseif (ewr_CurrentHost () == "ambico2.890m.com") { // setting koneksi database untuk komputer server
		$info["host"] = "mysql.idhostinger.com";  // sesuaikan dengan ip address atau hostname komputer server
