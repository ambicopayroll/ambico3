...
<?php if (!isset($pembagian1_edit->Pager)) $pembagian1_edit->Pager = new cNumericPager($pembagian1_edit->StartRec, $pembagian1_edit->DisplayRecs, $pembagian1_edit->TotalRecs, $pembagian1_edit->RecRange) ?>
...
<div class="ewNumericPage"><ul class="pagination">
	...
	<li><a href="<?php echo $pembagian1_edit->PageUrl() ?>start=<?php echo $pembagian1_edit->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($pembagian1_edit->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $pembagian1_edit->PageUrl() ?>start=<?php echo $pembagian1_edit->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($pembagian1_edit->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $pembagian1_edit->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($pembagian1_edit->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $pembagian1_edit->PageUrl() ?>start=<?php echo $pembagian1_edit->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($pembagian1_edit->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $pembagian1_edit->PageUrl() ?>start=<?php echo $pembagian1_edit->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</div>
<?php } ?>
