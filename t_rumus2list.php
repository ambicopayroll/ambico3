	...
	function AddRow($rsold = NULL) {
		...
		if ($bInsertRow) {
			...
			if ($AddRow) {
				...
				$rsnew['rumus2_id'] = $this->rumus2_id->DbValue;
			}
		} else {
			if ($this->getSuccessMessage() <> "" || $this->getFailureMessage() <> "") {
...
<?php } ?>
<?php if ($t_rumus2_list->TotalRecs > 0) { ?>
<div class="ewPager">
<input type="hidden" name="t" value="t_rumus2">
...
<?php if ($t_rumus2_list->TotalRecs > 0 || $t_rumus2->CurrentAction == "add" || $t_rumus2->CurrentAction == "copy") { ?>
