...
class ct_rumus extends cTable {
	...
	function __construct() {
		...
		// hk_gol
		$this->hk_gol = new cField('t_rumus', 't_rumus', 'x_hk_gol', 'hk_gol', '`hk_gol`', '`hk_gol`', 16, -1, FALSE, '`hk_gol`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->hk_gol->EditValue = $this->hk_gol->CurrentValue;
