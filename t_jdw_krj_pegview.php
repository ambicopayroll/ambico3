...
$t_jdw_krj_peg_view = NULL; // Initialize page object first

class ct_jdw_krj_peg_view extends ct_jdw_krj_peg {
	...
	// Page object name
	var $PageObjName = 't_jdw_krj_peg_view';
	...
	function __construct() {
		...
		$KeyUrl = "";
		if (@$_GET["jdw_id"] <> "") {
			$this->RecKey["jdw_id"] = $_GET["jdw_id"];
			$KeyUrl .= "&amp;jdw_id=" . urlencode($this->RecKey["jdw_id"]);
		}
	...
	function Page_Init() {
		...
		if (@$_GET["jdw_id"] <> "") {
			...
			$gsExportFile .= ew_StripSlashes($_GET["jdw_id"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["jdw_id"] <> "") {
				...
				$this->jdw_id->setFormValue($_POST["jdw_id"]);
				$this->RecKey["jdw_id"] = $this->jdw_id->FormValue;
			} else {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "t_jdw_krj_peglist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "t_jdw_krj_peglist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t_jdw_krj_peg_view)) $t_jdw_krj_peg_view = new ct_jdw_krj_peg_view();

// Page init
$t_jdw_krj_peg_view->Page_Init();

// Page main
$t_jdw_krj_peg_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_jdw_krj_peg_view->Page_Render();
?>
...
var CurrentForm = ft_jdw_krj_pegview = new ew_Form("ft_jdw_krj_pegview", "view");

// Form_CustomValidate event
ft_jdw_krj_pegview.Form_CustomValidate = 
...
ft_jdw_krj_pegview.ValidateRequired = true;
<?php } else { ?>
ft_jdw_krj_pegview.ValidateRequired = false; 
<?php } ?>
...
<?php if ($t_jdw_krj_peg->Export == "") { ?>
<div class="ewToolbar">
<?php if (!$t_jdw_krj_peg_view->IsModal) { ?>
<?php if ($t_jdw_krj_peg->Export == "") { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php } ?>
<?php $t_jdw_krj_peg_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t_jdw_krj_peg_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t_jdw_krj_peg_view->IsModal) { ?>
<?php if ($t_jdw_krj_peg->Export == "") { ?>
...
<?php } ?>
<?php $t_jdw_krj_peg_view->ShowPageHeader(); ?>
<?php
$t_jdw_krj_peg_view->ShowMessage();
?>
<?php if (!$t_jdw_krj_peg_view->IsModal) { ?>
<?php if ($t_jdw_krj_peg->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($t_jdw_krj_peg_view->Pager)) $t_jdw_krj_peg_view->Pager = new cPrevNextPager($t_jdw_krj_peg_view->StartRec, $t_jdw_krj_peg_view->DisplayRecs, $t_jdw_krj_peg_view->TotalRecs) ?>
<?php if ($t_jdw_krj_peg_view->Pager->RecordCount > 0 && $t_jdw_krj_peg_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($t_jdw_krj_peg_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $t_jdw_krj_peg_view->PageUrl() ?>start=<?php echo $t_jdw_krj_peg_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($t_jdw_krj_peg_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $t_jdw_krj_peg_view->PageUrl() ?>start=<?php echo $t_jdw_krj_peg_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $t_jdw_krj_peg_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($t_jdw_krj_peg_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $t_jdw_krj_peg_view->PageUrl() ?>start=<?php echo $t_jdw_krj_peg_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($t_jdw_krj_peg_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $t_jdw_krj_peg_view->PageUrl() ?>start=<?php echo $t_jdw_krj_peg_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $t_jdw_krj_peg_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="ft_jdw_krj_pegview" id="ft_jdw_krj_pegview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_jdw_krj_peg_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_jdw_krj_peg_view->Token ?>">
<?php } ?>
...
<?php echo $t_jdw_krj_peg->pegawai_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jdw_krj_peg->tgl1->Visible) { // tgl1 ?>
	<tr id="r_tgl1">
		<td><span id="elh_t_jdw_krj_peg_tgl1"><?php echo $t_jdw_krj_peg->tgl1->FldCaption() ?></span></td>
...
<?php echo $t_jdw_krj_peg->tgl1->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jdw_krj_peg->tgl2->Visible) { // tgl2 ?>
	<tr id="r_tgl2">
		<td><span id="elh_t_jdw_krj_peg_tgl2"><?php echo $t_jdw_krj_peg->tgl2->FldCaption() ?></span></td>
...
<?php echo $t_jdw_krj_peg->tgl2->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_jdw_krj_peg->jk_id->Visible) { // jk_id ?>
	<tr id="r_jk_id">
		<td><span id="elh_t_jdw_krj_peg_jk_id"><?php echo $t_jdw_krj_peg->jk_id->FldCaption() ?></span></td>
...
<?php if ($t_jdw_krj_peg->Export == "") { ?>
<script type="text/javascript">
ft_jdw_krj_pegview.Init();
</script>
<?php } ?>
<?php
$t_jdw_krj_peg_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<?php if ($t_jdw_krj_peg->Export == "") { ?>
...
<?php
$t_jdw_krj_peg_view->Page_Terminate();
?>
