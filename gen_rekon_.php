...
$gen_rekon__php = NULL; // Initialize page object first

class cgen_rekon__php {
	...
	// Table name
	var $TableName = 'gen_rekon_.php';

	// Page object name
	var $PageObjName = 'gen_rekon__php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'gen_rekon_.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "gen_rekon__php", $url, "", "gen_rekon__php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($gen_rekon__php)) $gen_rekon__php = new cgen_rekon__php();

// Page init
$gen_rekon__php->Page_Init();

// Page main
$gen_rekon__php->Page_Main();
