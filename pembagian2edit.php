...
<?php if (!isset($pembagian2_edit->Pager)) $pembagian2_edit->Pager = new cNumericPager($pembagian2_edit->StartRec, $pembagian2_edit->DisplayRecs, $pembagian2_edit->TotalRecs, $pembagian2_edit->RecRange) ?>
...
<div class="ewNumericPage"><ul class="pagination">
	...
	<li><a href="<?php echo $pembagian2_edit->PageUrl() ?>start=<?php echo $pembagian2_edit->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($pembagian2_edit->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $pembagian2_edit->PageUrl() ?>start=<?php echo $pembagian2_edit->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($pembagian2_edit->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $pembagian2_edit->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($pembagian2_edit->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $pembagian2_edit->PageUrl() ?>start=<?php echo $pembagian2_edit->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($pembagian2_edit->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $pembagian2_edit->PageUrl() ?>start=<?php echo $pembagian2_edit->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</div>
<?php } ?>
